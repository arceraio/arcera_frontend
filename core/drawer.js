      ...
      <div class="drawer-header">
        <div class="drawer-header-user">
          ...
          <div class="drawer-user-info">
            ...
            <div class="drawer-user-email"></div>
          </div>
        </div>
      </div>
      <nav class="drawer-menu">
        <div class="drawer-section">
          <p class="drawer-section-title">Main</p>
          <ul>
        ...
        <div class="drawer-section">
          <p class="drawer-section-title">Support</p>
          <ul>
...
export function init(openCamera, navigate, user, openSettings) {
  ...
  if (user) {
    ...
    const name = meta.full_name || meta.name ||
      (email ? email.split('@')[0].replace(/[._]/g, ' ').replace(/\b\w/g, c => c.toUpperCase()) : 'Account');
    drawer.querySelector('.drawer-user-name').textContent = name;
    drawer.querySelector('.drawer-user-email').textContent = email;
  }
    ...
    item.addEventListener('click', async () => {
      ...
      if (nav === 'scan') {
        ...
        try {
          ...
          window.location.href = `${API}/export/${data.member_id}`;
        } catch {
